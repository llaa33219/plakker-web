  ...
  -F "emoticons=@emoticon3.png"</pre>
        ...
        <div class="api-section">
            ...
            <ul>
                ...
                <li><strong>거부:</strong> 부정적 의도/타인 비하 내용 (매우 엄격한 다국어 검열)
                    <ul style="margin-top: 5px;">
                        <li>상대방을 무시하거나 깎아내리는 모든 표현</li>
                        <li>비꼬거나 조롱하는 어투의 텍스트 (냉소적, 빈정거리는 표현)</li>
                        <li>상대방의 능력이나 수준을 의심하거나 폄하하는 표현</li>
                        <li><strong>모든 언어 지원:</strong> 한국어, 영어, 일본어, 중국어, 스페인어, 프랑스어, 독일어, 러시아어, 아랍어, 힌디어, 포르투갈어, 이탈리아어, 네덜란드어, 태국어, 베트남어, 인도네시아어 등</li>
                        <li>은어, 줄임말, 우회 표현을 통한 검열 회피 시도</li>
                        <li>조롱이나 경멸을 나타내는 이모티콘이나 기호</li>
                    </ul>
                </li>
            </ul>
